...
const history: SaleSummary[] = [
  { id: "sale-1", businessId: "business-1", saleReference: "SALE-000001", soldAt: "2026-09-20T12:00:00Z", subtotal: "106.5122", total: "106.5122", notes: "Counter order", createdBy: "user-1", itemCount: 1, items: [{ productName: "Phone Case", productSku: "CASE-01" }] },
  { id: "sale-2", businessId: "business-1", saleReference: "SALE-000002", soldAt: "2026-09-21T12:00:00Z", subtotal: "25", total: "25", notes: null, createdBy: "user-2", itemCount: 1, items: [{ productName: "Tea", productSku: "TEA-2" }] },
]
