...
describe("inventory service product writes", () => {
  ...
  it("preserves exact numeric movement balances and the Sales source", async () => {
    ...
    expect(movements[0]).toMatchObject({ quantity: "-0.333", quantityBefore: "999999999999999.999", quantityAfter: "999999999999999.666", sourceType: "sales", sourceReference: "sale-1" })
